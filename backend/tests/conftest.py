...
from backend.app.routers.ai import _ai_request_log
...
def _reset_ai_rate_limit() -> None:
    ...
    _ai_request_log is process-global (see routers/ai.py), so without this
    reset, tests across different files that call /api/ai/respond or
